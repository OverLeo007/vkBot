...
class VkBot:
    ...
    def new_message(self, message):
        ...
        # Расписание
            ...
            mes = "Мб не точный, пушто я фотал все в понедельник, но ваш список мучений:", photo
        # Кто
        elif {message1.split()[0]} & self.commands[4]:
        ...
        for event in longpoll.listen():
            if event.type == VkEventType.MESSAGE_NEW:
                if event.to_me:
                    ...
                    if event.text == '/'.strip():
                        bot.write_msg('Доступные комманды: привет, время, пока, расписание, кто *текст*')
